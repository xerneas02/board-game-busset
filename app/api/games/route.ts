...
export async function POST(request:NextRequest) {
  ...
  try {
    const result=db.prepare("INSERT INTO games(slug,name,coverPath,minPlayers,maxPlayers,estimatedMinutes,difficulty,rating,notes,rulesUrl,tags) VALUES(?,?,?,?,?,?,?,?,?,?,?)").run(slug,name,body.coverPath||null,body.minPlayers,body.maxPlayers,body.estimatedMinutes||null,body.difficulty||null,body.rating||null,body.notes||null,body.rulesUrl||null,JSON.stringify(cleanTags(body.tags)));
