...
const choose=(players:number,minutes?:number,difficulty:Filter="all")=>seedGames.filter(game=>game.min<=players&&game.max>=players&&difficultyMatches(game.difficulty,difficulty)&&(!minutes||(game.minutes!==undefined&&(minutes===60?game.minutes>=30&&game.minutes<=60:minutes===30?game.minutes<30:game.minutes>60))));
